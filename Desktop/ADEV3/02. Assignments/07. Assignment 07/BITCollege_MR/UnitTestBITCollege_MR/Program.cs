...
namespace UnitTestBITCollege_MR
{
        ...
        
    {
        ...
        static void HonoursStateGradePointAvg_801()
        {

            // Set up test Student
            Student student = db.Students.Find(801); // Modify as needed
            student.GradePointAverage = 4.25;
            ...
            //Output the expected and actual values
            Console.WriteLine("Expected: 2217.50");
            Console.WriteLine("Actual: " + tuitionRate);
